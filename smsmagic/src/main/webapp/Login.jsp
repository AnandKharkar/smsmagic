...
<head>
    ...
    <style>
        body {
            background: url('https://img.freepik.com/premium-photo/blue-abstract-art-composition-empty-space-4k-background-illustration-3d-rendering_594417-837.jpg') no-repeat center center fixed;
